...
1. run file baby_ransomware.py เลือก mode 1 จะทำการรันเข้ารหัสไฟล์ที่ระบุไว้ แล้วสร้างไฟล์ localkey
...
โปรแกรมจะไม่ถามชื่อไฟล์ที่จะเข้ารหัส หรือถอดรหัสนะ เพราะโจทย์สั่งไว้ว่าให้ "ระบุชื่อไฟล์เป้าหมายที่แน่นอนในโปรแกรม" ระบุไปแล้วใน baby_ransomware.py
ไฟล์ localkey ถูกเข้ารหัสด้วย rsa public key จึงเปิดอ่านไม่ได้
ในนี้ใส่ RSA ไปในไฟล์ RSAKey.txt คือสร้างแล้วนะ รู้ pv key และ pb key แล้ว(รันครั้งเดียวแล้วเอาไปใช้ได้เลย) เลยเอามาวางไว้เลยนะ
ไฟล์ baby_ransomware_test.py เป็นไฟล์ที่ทำขึ้นมา test งานเฉยๆนะ 
